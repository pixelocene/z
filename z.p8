...
function new_turn()
	turn+=1
	local pop=0
	if turn>=1 and turn<4 then pop=3 end
	if turn>=4 and turn<6 then pop=4 end
	if turn>=7 then pop=5 end
	for i=1,pop do
		generate_zombie()
	end
end
	...
	for x=1,15 do
		for y=1,15 do
			...
			if is_street_tile and not is_occupied then
				add(available_street_tiles,{x=x,y=y})
			end
		end
	end
	-- create a zombie and add him to the list
	local coords=available_street_tiles[ceil(rnd(#available_street_tiles))]
	add(zombies,{
		hp=1,
		actions=2,
		x=coords.x,
...
function draw_zombies()
	for zombie in all(zombies) do
		palt(0,false)
		palt(14,true)
		spr(33,(zombie.x+1)*8,(zombie.y+1)*8)
		palt(0,true)
		palt(14,false)
	end
end
...

...

